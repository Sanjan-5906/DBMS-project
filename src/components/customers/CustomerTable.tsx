      ...
      <CardHeader className="space-y-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
            <div className="flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
              <UserRound className="h-4 w-4 text-blue-800" />
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button className="rounded-xl bg-blue-800 hover:bg-blue-900 text-white shadow-md shadow-blue-900/20 lg:w-fit" onClick={onAddCustomer}>
        ...
        {showNoResults ? (
          <div className="rounded-[1.75rem] border border-dashed border-blue-200 bg-blue-50/70 p-8 text-center dark:border-slate-700 dark:bg-slate-900">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              ...
              <Button className="rounded-xl bg-blue-800 hover:bg-blue-900 text-white" onClick={onAddCustomer}>
                <PlusCircle className="h-4 w-4 mr-2" />
                Add Customer
              </Button>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 bg-white dark:bg-slate-900">
                  {hasRecords ? (
                    customers.map((customer) => (
                      <tr key={customer.id} className="group transition-colors hover:bg-blue-50/60">
