      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 relative">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            <Badge variant="outline" className="w-fit rounded-full px-4 py-1.5 bg-yellow-50 text-amber-800 border-yellow-200">
          ...
          <Button className="w-fit rounded-xl bg-amber-600 hover:bg-amber-700 text-white shadow-md shadow-amber-900/20" size="lg" onClick={handleAddCustomer} disabled={isSubmitting}>
