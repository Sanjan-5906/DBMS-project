    ...
    <div className="space-y-8 animate-fade-up">
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 relative">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Button className="w-fit rounded-xl bg-amber-600 hover:bg-amber-700 text-white shadow-md shadow-amber-900/20" size="lg" onClick={handleAddAccount} disabled={isSubmitting}>
